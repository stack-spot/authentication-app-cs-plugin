- **Descrição:** O plugin `authentication-app-cs-plugin` adiciona em uma stack a capacidade de verificar se um usuário possui acesso a um determinado recurso restrito. 
